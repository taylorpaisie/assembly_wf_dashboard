...
def get_data_display():
    return dbc.Row([
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardHeader(html.H5("Bar Plot Controls", className="text-white")),
                dbc.CardBody([
                    html.Div([
...
def get_sankey_section():
    return dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardHeader(html.H5("Sankey Plot Controls", className="text-white")),
                dbc.CardBody([
                    html.Div([
                        html.Label("Select a Sheet:", className="fw-bold"),
                        dcc.Dropdown(id='sankey-sheet-dropdown', placeholder="Select a sheet"),
                    ], className="mb-3"),
