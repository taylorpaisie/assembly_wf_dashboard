    ...
    return dbc.Container(
        [
            ...
            html.P([
                ...
                " data. It supports Kraken2 TSV outputs and Excel files, allowing users to visualize Sankey plots and bar plots for assembly depth."
            ]),
            html.P("""
            ...
            html.Ul([
                html.Li("🔹 Upload Kraken TSV or Excel files"),
